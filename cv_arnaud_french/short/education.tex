...
\begin{cventries}
  ...
  {Oct. 2014 -- Nov. 2018} % Date(s)
  {
    ...
    \item \entrypositionstyle{Titre} : « SLAM visuel pour la localisation et la commande en boucle fermée de
      robots humanoïdes » supervisé par \emph{Dr. Comport} et \emph{Dr. Kheddar}.
    ...
    \item \entrypositionstyle{Locomotion} : Marche par commande prédictive (MPC) en boucle fermée
      (force/IMU/SLAM). Validation expérimentale sur \emph{HRP-4}.
  ...
  {
    \begin{cvitems}
    \item Apprentissage autodidacte du C++/Qt - Co-développement international de Fotowall, application
      open-source de manipulation d'images.
    \end{cvitems}
  }
